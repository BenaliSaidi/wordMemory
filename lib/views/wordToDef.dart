...
class WordToDef extends StatefulWidget {
  const WordToDef({Key? key}) : super(key: key);

  @override
  State<WordToDef> createState() => _WordToDefState();
}
...
getNotSavedWord() {
  ...
  var myValues = Hive.box("myWord")
      .values
      .where((element) => element.wordToDef == false)
      .toList()
      .forEach((element) {
    ...
    myStatusList.add(element.defToWord);
  });
}

editSavedStatus(String word, String definition, bool status) {
  Hive.box("myWord").delete(word);
  Hive.box("myWord").put(word, MyWord(word, definition, true, status));
}
...
class _WordToDefState extends State<WordToDef> {
  void initState() {
    super.initState();
    getNotSavedWord();
  }
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Card(
              child: Container(
                color: Color.fromARGB(255, 250, 220, 197),
            ...
            child: SwipingCardDeck(
              ...
              onLeftSwipe: (Card card) {
                ...
                scratchKey.currentState!
                    .reset(duration: Duration(milliseconds: 200));
              },
          ...
          Scratcher(
            ...
            child: Container(
                color: Color.fromARGB(255, 177, 245, 175),
                alignment: Alignment.center,
                height: 60,
